...
python3 exp/spatial_correction_cityscapes/python/show.py \
            ...
            --save_path /gdata1/zhuangjf/git_repo/DAVSS/result/spatial_correction_cityscapes \
            --scnet_model /gdata1/zhuangjf/git_repo/DAVSS/saved_model/spatial_correction_cityscapes/best.pth \
            --num_workers 8