...
python3 -m torch.distributed.launch --nproc_per_node=4 --master_port=$RANDOM exp/spatial_correction_cityscapes/python/train.py \
        ...
        --num_epoch 100 \
        --snap_shot 5 \
        --model_save_path /ghome/zhuangjf/git_repo/DAVSS/saved_model/spatial_correction_cityscapes \
        --tblog_dir /ghome/zhuangjf/git_repo/DAVSS/tblog/spatial_correction_cityscapes