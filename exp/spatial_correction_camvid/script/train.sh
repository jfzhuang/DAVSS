...
python3 -m torch.distributed.launch --nproc_per_node=4 --master_port=$RANDOM exp/spatial_correction_camvid/python/train.py \
        ...
        --dmnet_load_path /gdata1/zhuangjf/git_repo/DAVSS/saved_model1/dmnet_camvid/now.pth \
        --lr 1e-4 \
        --cfnet_lr 1e-4 \
        --random_seed 666 \
        --weight_decay 0 \
        ...
        --num_epoch 100 \
        --snap_shot 5 \
        --model_save_path /ghome/zhuangjf/git_repo/DAVSS/saved_model1/spatial_correction_camvid \
        --tblog_dir /ghome/zhuangjf/git_repo/DAVSS/tblog1/spatial_correction_camvid